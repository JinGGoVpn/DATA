...
iptables -I INPUT 1 -i $SERVER_PUB_NIC -p udp --dport 8000 -j ACCEPT
...
# Tambahan
cd /usr/local/bin
wget -O add-wg "https://raw.githubusercontent.com/JinGGoVPN/DATA/main/WG/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/JinGGoVPN/DATA/main/WG/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/JinGGoVPN/DATA/main/WG/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/JinGGoVPN/DATA/main/WG/renew-wg.sh"
chmod +x mwg
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
