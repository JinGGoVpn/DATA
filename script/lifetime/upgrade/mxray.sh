...
vlesslink4="vless://${uuid}@$dom:8080?mode=auto&path=$path/xvless-xhttp-ntls&encryption=none&type=xhttp&host=$dom#${user}"
...
maxisfrez="vless://${uuid}@cdn.opensignal.com:8080?mode=auto&path=$path/xvless-xhttp-ntls&encryption=none&type=xhttp&host=cdn.opensignal.$dom#${user}-max-frez"
