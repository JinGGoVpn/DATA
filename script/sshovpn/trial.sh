...
echo -e "==============================="
echo -e "PAYLOAD SSH WS HTTPS: GET wss://SNI_bug_host/ HTTP/1.1[crlf]Host: ${domain}[crlf]Upgrade: Websocket[crlf]Connection: Keep-Alive[crlf][crlf]"
echo -e "==============================="
