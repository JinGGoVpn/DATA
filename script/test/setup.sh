...
#Welcome Note
echo -e "============================================="
echo -e " ${green} WELCOME TO PREMIUM SCRIPT LIFETIME${NC}"
echo -e "============================================="
sleep 2
...
echo -e "============================================="
sleep 2
wget ${websc}/script/test/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
sleep 2
clear
...
echo -e "============================================="
sleep 2
wget ${websc}/script/xray/vision/install-xray.sh && chmod +x install-xray.sh && ./install-xray.sh
sleep 2
clear
