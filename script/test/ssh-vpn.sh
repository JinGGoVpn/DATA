...
# // menu ssh-ovpn
wget -O usernew "${websc}/script/v3/usernew.sh"
wget -O trial "${websc}/script/v3/trial.sh"
...
wget -O restart-service "${websc}/script/v3/restart-service.sh"
...
wget -O status "${websc}/script/v3/status.sh"
wget -O update "${websc}/script/v3/update.sh"


# menu
wget -O menu "${websc}/script/lifetime/menu.sh"
wget -O mwarp "${websc}/script/warp/mwarp.sh"
